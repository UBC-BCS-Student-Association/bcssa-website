  ...
  return (
    ...
    <Tabs className={styles.tabs} defaultValue="tab1">
      <TabsList className={styles.tabsList}>
          ...
          <TabsTrigger className={styles.tabsTrigger} value="tab2">Team</TabsTrigger>
      </TabsList>
      <TabsContent className={styles.tabsContent} value="tab1">
        <p class="text-l ...">The Why</p>
        <p>
        The Bachelor of Computer Science Students Association (BCSSA) is a student club for students completing their second degree in the Bachelor of Computer Science (BCS) Program at UBC. 
        ...
        <p>
        For our members, the BCSSA aims to foster an equitable, diverse and inclusive community. 
