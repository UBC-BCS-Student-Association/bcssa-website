...
const eventsData = [
  {
    ...
    eventDescription: 'The first BCS social event of the new year saw BCS students and friends enjoying local brews in Olympic Village.',
    eventImages: ['/events/2023-01-08-Pub-Crawl/BCSPubCrawlJan82023.jpeg'],
  },
  {
    eventDate: '2023-01-27',
    eventName: 'Jan Social at The Gallery',
    eventDescription: 'BCSers gathered for a casual social event at the Gallery to kick off the weekend with drinks and snacks.',
  ...
  },
  {
    ...
    eventDescription: 'To kick off reading break, BCSSA hosted another successful social event at the Gallery.',
  ...
  },
  {
    ...
    eventDescription: 'BCSSA celebrated Easter with a nostalgic egg hunt in the computer science building, featuring three chocolate-redeemable tickets hidden daily.',
    eventImages: ['/events/2023-04-03 to 06 BCS Easter Egg Hunt/339315233_198901296191100_6839892246812770189_n.jpg'],
  },
  {
    eventDate: '2023-04-19',
    eventName: 'Term 2 BCSSA Gathering',
    eventDescription: 'BCSSA team dinner: celebrating a successful term, hard work, and team bonding with food, drinks, and board games.',
  ...
  },
  {
    ...
    eventDescription: 'BCSers celebrated the start of the summer semester in style, enjoying delicious Rain or Shine ice cream, badminton and frisbee!',
    eventImages: [
